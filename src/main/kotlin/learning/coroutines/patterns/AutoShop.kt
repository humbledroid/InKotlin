 ...
 *
 * here we can see, that diagnose, repair, and testDrive are sequential and not concurrent,
 * all 3 cars can be processed concurrently, but these steps are sequential in nature per car
 * thus doesn't require more coroutines, this removed
 */
