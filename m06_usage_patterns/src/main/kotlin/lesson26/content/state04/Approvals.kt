package lesson26.content.state04

import kotlinx.coroutines.coroutineScope
import kotlinx.coroutines.launch
import lesson26.content.state04.adapter.ApprovalState
import lesson26.content.state04.adapter.ApprovalSystem
        ...
        requests.forEach { (customerId, estimate) ->
            launch {
                ...
                when (result) {
                    ...
                    ApprovalState.ERROR    -> println("💥 Customer $customerId could not be contacted due to a system error.")
                }
            }
        }
    }
